                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mt-4">
                            <a class="btn btn-primary btn-square rounded-circle me-2" href="{{asset('asset')}}#"><i
                                    class="fab fa-twitter"></i></a>
                            <a class="btn btn-primary btn-square rounded-circle me-2" href="{{asset('asset')}}#"><i
                                    class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-primary btn-square rounded-circle me-2" href="{{asset('asset')}}#"><i
                                    class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-primary btn-square rounded-circle" href="{{asset('asset')}}#"><i
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="{{asset('asset')}}#"><i
                            ...
                            <a class="text-secondary" href="{{asset('asset')}}#"><i
        ...
        <div class="row gx-5">
            <div class="col-lg-8">
                <div class="py-lg-4 text-center">
                    <p class="text-secondary mb-0">&copy; <a class="text-light fw-bold" href="{{asset('asset')}}#">Your Site Name</a>. All
                        Rights Reserved. Distributed by <a class="text-light fw-bold"
                            href="{{asset('asset')}}https://themewagon.com">ThemeWagon</a></p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="py-lg-4 text-center credit">
                    ...
                    <p class="text-light mb-0">Designed by <a class="text-light fw-bold" target="_blank"
                            href="{{asset('asset')}}https://htmlcodex.com">HTML Codex</a></p>
                </div>
            </div>
        </div>
    </div>